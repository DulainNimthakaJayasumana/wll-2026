...
const SOCIAL = [
  {
    ...
    cta: '▶ Watch Reel',
    bg: 'linear-gradient(135deg,#1a2a4a 0%,#0d1b2e 100%)',
  },
  {
    platform: 'Instagram',
    outlet: 'Eduwire',
  ...
  return (
    ...
    <div className={s.page}>
      ...
      <section className={s.hero}>
        <div className={s.heroBar}>{SDG_COLORS.map((c,i)=><span key={i} style={{background:c}}/>)}</div>
        <div className={s.heroInner}>
          <div className={s.heroBadge}>AIESEC in Sri Lanka · WLL 2026</div>
          <h1 className={s.heroTitle}>In the<br/><em className={s.heroEm}>Media</em></h1>
          <p className={s.heroSub}>WLL 2026 is making waves across Sri Lanka's media landscape — watch, read, and share our story.</p>
        </div>
        <div className={s.heroWave}>
          <svg viewBox="0 0 1440 80" preserveAspectRatio="none"><path d="M0,40 C360,80 1080,0 1440,40 L1440,80 L0,80 Z" fill="var(--page-bg)"/></svg>
        </div>
      </section>
      ...
      <section className={s.section} data-reveal>
        <div className={s.container}>
          <div className={s.sectionHead}>
            <span className={s.sectionLabel}>📻 EFM RADIO · ANNOUNCEMENT</span>
            <h2 className={s.sectionTitle}>Hear it on Air</h2>
            <p className={s.sectionSub}>eFM Radio broadcast our WLL 2026 announcement to the nation. Play the clip below.</p>
          </div>
      ...
      <section className={s.section} data-reveal>
        <div className={s.container}>
          <div className={s.sectionHead}>
            <span className={s.sectionLabel}>📺 CHANNEL 9 · OFFICIAL COVERAGE</span>
            <h2 className={s.sectionTitle}>WLL 2026 Launch — Full Video</h2>
          ...
          <div className={s.videoWrap}>
            <iframe className={s.videoFrame} src="https://www.youtube.com/embed/SQhFArEWRgc"
      ...
      <section className={s.section} data-reveal>
        <div className={s.container}>
          <div className={s.sectionHead}>
            <span className={s.sectionLabel}>📰 PRESS COVERAGE</span>
            <h2 className={s.sectionTitle}>News Articles</h2>
          </div>
            ...
            {ARTICLES.map((a, i) => (
              <a key={i} className={s.articleCard} href={a.url} target="_blank" rel="noopener noreferrer">
                ...
                <div className={s.articleBody}>
                  ...
                  <h3 className={s.articleHeadline}>{a.title}</h3>
                  ...
                  <div className={s.articleFooter}>
                    ...
                    <span className={s.articleCta} style={{'--ac': a.outletColor}}>
                      Read Full Article →
                    </span>
                  </div>
                </div>
      ...
      <section className={s.section} data-reveal>
        <div className={s.container}>
          <div className={s.sectionHead}>
            <span className={s.sectionLabel}>📱 SOCIAL MEDIA</span>
            <h2 className={s.sectionTitle}>Reels &amp; Posts</h2>
          </div>
